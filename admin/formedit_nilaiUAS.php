<?php 
$title="Form Edit Data Nilai UAS";
$page="Data Nilai UAS";
...
$nis    = $data_siswa['nis'];
// data siswa
$query_nilaiuasp  = mysqli_query($connect,"SELECT * FROM nilai_uas, mata_pelajaran WHERE nilai_uas.nis='$nis' AND nilai_uas.kode_pelajaran = mata_pelajaran.kode_pelajaran");
?>
<body>
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <!-- content card -->
                  <form class="forms-sample" action="../functions/nilaiUAS_update.php?id=<?= $id?>" method="POST">
                    <input type="hidden" name="nis" value="<?=$nis?>">
                    <?php foreach ($query_nilaiuasp as $Index=>$data_uasp): ?>
                      <div class="form-group">
                        <label for="nilai_uas"><?= $data_uasp['mata_pelajaran'] ?></label>

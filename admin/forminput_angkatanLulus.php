<?php 
$title="Form Data Mata Angkatan Kelulusan";
                      ...
                      <br>
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group">
                              <br>
                              <label for="mata_pelajaran"><b>Mata Pelajaran UAS</b></label>
                              <?php foreach ($query as $Index=>$Data): ?>
                              <div class="form-check form-check-flat">
                                <label class="form-check-label">
                                  <input type="checkbox" class="form-check-input" name="mapel_uas[]" value="<?= $Data['kode_pelajaran'] ?>">(<?= $Data['kode_pelajaran'] ?>) &nbsp;&nbsp; <?= $Data['mata_pelajaran'] ?>
                                </label>
                              </div>
                              <?php endforeach; ?>
                            </div>
                          ...
                          <div class="col-md-6">
                            <div class="form-group"><br>
                              <label for="mata_pelajaran"><b>Mata Pelajaran UAS Provinsi</b></label>
                              <?php foreach ($query as $Index=>$Data): ?>
                              <div class="form-check form-check-flat">
                                <label class="form-check-label">
                                  <input type="checkbox" class="form-check-input" name="mapel_uasp[]" value="<?= $Data['kode_pelajaran'] ?>">(<?= $Data['kode_pelajaran'] ?>) &nbsp;&nbsp; <?= $Data['mata_pelajaran'] ?>
                                </label>
                              </div>
                              <?php endforeach; ?>
                            </div>

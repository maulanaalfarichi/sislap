...
$nis              = $data_siswa['nis'];
// data siswa
$query_mapeluasp  = mysqli_query($connect,"SELECT * FROM angkatan_lulus, mata_pelajaran WHERE angkatan_lulus.kode_pelajaran = mata_pelajaran.kode_pelajaran AND angkatan_lulus.tahun_ajaran='$tahun_ajaran' AND angkatan_lulus.status='0'");
?>
<body>
        ...
        <div class="content-wrapper">
          ...
          <div class="row">
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title" align="center">Form Data Nilai UAS</h4>
                  <!-- <p class="card-description">
                    Add class <code>.table</code>
                  </p> -->
                  <!-- content card -->
                  <form class="forms-sample" action="../functions/nilaiUAS_insert.php?id=<?= $id?>" method="POST">

<?php 
$title="Form Edit Data Nilai UAS Provinsi";
$page="Data Nilai UAS";
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <!-- content card -->
                  <form class="forms-sample" action="../functions/nilaiUASP_update.php?id=<?= $id?>" method="POST">
                    <input type="hidden" name="nis" value="<?=$nis?>">
                    <?php foreach ($query_nilaiuasp as $Index=>$data_uasp): ?>
                      <div class="form-group">
                        <label for="nilai_uasp"><?= $data_uasp['mata_pelajaran'] ?></label>
